...
<head>
    ...
    <title>{{ env('APP_NAME', 'DataSiswa') }} - Login</title>
        ...
        <div class="shadow-lg sm:mx-auto sm:w-full sm:max-w-md px-5 py-2">
            ...
            <div class="mt-10 w-full">
                <form class="space-y-6" action="{{ route('register') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="name" name="name" type="text" autocomplete="name" required
                                class="block w-full rounded-md border-0 pl-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="text-sm">
                        <a href="{{ route('login') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Sudah
                            Punya Akun</a>
                    </div>
                    <div>
                        <button type="submit"
