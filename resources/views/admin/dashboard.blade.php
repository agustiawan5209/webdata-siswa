            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                                ...
                                @foreach ($siswas as $siswa)
                                    <tr class="bg-white hover:bg-gray-50">
                                        ...
                                        <td class="h-px w-72 min-w-[18rem] align-top">
                                            <div class="block p-6">
                                                <span class="block text-sm text-gray-500">{{ $siswa->email }}</span>
                                            ...
                                            <div class="block p-6">
                                                <div class="flex items-center gap-x-4 justify-center">
                                                    <img class="flex-shrink-0 h-[2.375rem] w-[2.375rem] rounded-lg"
                                                        src="{{ $siswa->foto_path }}" alt="Image Description">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="h-px w-px whitespace-nowrap align-top">
                                            <div class="flex p-6 gap-x-3">
                                                <a class="block" href="{{ route('Siswa.edit', ['id' => $siswa->id]) }}">
                                                    <span
                                                ...
                                                <button onclick="return confirmDelete({{ $siswa->id }})"
                                                    data-id="{{ $siswa->id }}">
                                                    <span
                        ...
                        <form action="" class="hidden" method="POST" id="form-delete">
                            @csrf
                            @method('delete')
                        </form>
                        <!-- End Table -->
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "{{ route('Siswa.delete', ['id' => ':id']) }}";
